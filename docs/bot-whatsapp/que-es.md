...
Para proteger el sistema de uso malicioso, existe una lista negra de teléfonos. Si un número está en esa lista, el bot no lo atenderá. Podés gestionar esta lista desde el panel.
